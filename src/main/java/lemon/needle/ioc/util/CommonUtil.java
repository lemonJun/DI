...
public class CommonUtil {
    ...
    public static <T, P1, P2> T newInstance(Class<T> c, P1 p1, P2 p2) throws Exception {
        try {
    ...
    public static <T, P1, P2, P3> T newInstance(Class<T> c, P1 p1, P2 p2, P3 p3) throws Exception {
        try {
            Constructor[] ca = c.getConstructors();
            for (Constructor<T> ct : ca) {
                Class[] pts = ct.getParameterTypes();
    ...
    public static <T, P1, P2, P3, P4> T newInstance(Class<T> c, P1 p1, P2 p2, P3 p3, P4 p4) throws Exception {
        try {
            Constructor[] ca = c.getConstructors();
            for (Constructor<T> ct : ca) {
                Class[] pts = ct.getParameterTypes();
    ...
    public static <T, P1, P2, P3, P4, P5> T newInstance(Class<T> c, P1 p1, P2 p2, P3 p3, P4 p4, P5 p5) throws Exception {
        try {
            Constructor[] ca = c.getConstructors();
            for (Constructor<T> ct : ca) {
                Class[] pts = ct.getParameterTypes();
    ...
    public static <T> T newInstance(Class<T> c, Object p1, Object p2, Object p3, Object p4, Object p5, Object... pa) throws Exception {
        try {
            Constructor[] ca = c.getConstructors();
            int len = pa.length;
            for (Constructor<T> ct : ca) {
