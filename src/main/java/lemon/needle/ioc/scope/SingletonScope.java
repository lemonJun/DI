...
//import lemon.needle.ioc.scope.CycleDetectingLock.CycleDetectingLockFactory;
//
///**
...
//                                    T proxy = (T) constructionContext.createProxy(new Errors(), context.getInjectorOptions(), rawType);
//                                    return proxy;
