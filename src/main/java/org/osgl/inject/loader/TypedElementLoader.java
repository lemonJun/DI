...
//                    Class<?> c = o.getClass();
//                    return (loadNonPublic || Modifier.isPublic(c.getModifiers())) && (baseClass.isAssignableFrom(c) && (loadRoot || baseClass != c));
//                } else {
...
//     */
//    protected abstract List<Class<? extends T>> load(Class<T> type, boolean loadNonPublic, boolean loadAbstract, boolean loadRoot);
//
